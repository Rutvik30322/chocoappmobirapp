...
export const getAllBanners = async (req, res, next) => {
  try {
    ...
    // If active query param is not 'false', only show active banners for public access
    // Admin can see all by not passing active param or passing active=false
...
export const createBanner = async (req, res, next) => {
  try {
    ...
    // Handle image from middleware (Cloudinary upload)
    const bannerData = {
      title,
    ...
    // Handle file upload from form field
